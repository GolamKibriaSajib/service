...
const getTenantDB = require("./db"); // Create a DB pool connection
const getMasterDB = require("./dbMaster"); // Create DB pool for the master database.
...
//# sourceMappingURL=playerStatusUpdater.js.map